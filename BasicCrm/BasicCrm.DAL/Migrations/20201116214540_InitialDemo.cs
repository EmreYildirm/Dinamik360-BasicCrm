...
namespace BasicCrm.DAL.Migrations
{
    public partial class InitialDemo : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            string storedProcedures = @"CREATE PROCEDURE InsertCustomer
...
BEGIN
    SET NOCOUNT ON;
	INSERT Customers(CompanyName,Address,Phone)
...
END";
            ...
            migrationBuilder.Sql(storedProcedures);
